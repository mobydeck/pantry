// Vendored from github.com/ncruces/go-sqlite3/gormlite@v0.30.2
package gormlite
...
func (m _Migrator) HasTable(value any) bool {
	var count int
...
func (m _Migrator) DropTable(values ...any) error {
...
func (m _Migrator) HasColumn(value any, name string) bool {
	var count int
...
func (m _Migrator) AlterColumn(value any, name string) error {
	return m.RunWithoutForeignKey(func() error {
...
func (m _Migrator) ColumnTypes(value any) ([]gorm.ColumnType, error) {
...
func (m _Migrator) DropColumn(value any, name string) error {
	return m.recreateTable(value, nil, func(ddl *ddl, stmt *gorm.Statement) (*ddl, []any, error) {
		if field := stmt.Schema.LookUpField(name); field != nil {
			name = field.DBName
		}
...
func (m _Migrator) CreateConstraint(value any, name string) error {
...
func (m _Migrator) DropConstraint(value any, name string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		constraint, table := m.GuessConstraintInterfaceAndTable(stmt, name)
		if constraint != nil {
...
func (m _Migrator) HasConstraint(value any, name string) bool {
	var count int64
...
func (m _Migrator) BuildIndexOptions(opts []schema.IndexOption, stmt *gorm.Statement) (results []any) {
...
func (m _Migrator) CreateIndex(value any, name string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		if stmt.Schema != nil {
...
func (m _Migrator) HasIndex(value any, name string) bool {
	var count int
...
func (m _Migrator) RenameIndex(value any, oldName, newName string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		var sql string
...
func (m _Migrator) DropIndex(value any, name string) error {
	return m.RunWithValue(value, func(stmt *gorm.Statement) error {
		if stmt.Schema != nil {
			if idx := stmt.Schema.LookIndex(name); idx != nil {
				name = idx.Name
...
func (m _Migrator) GetIndexes(value any) ([]gorm.Index, error) {
