...
// to allow using go-sqlite3 v0.30.x with sqlite-vec bindings.
package gormlite
...
func (dialector _Dialector) BindVarTo(writer clause.Writer, stmt *gorm.Statement, v any) {
	writer.WriteByte('?')
}
...
func (dialector _Dialector) Explain(sql string, vars ...any) string {
