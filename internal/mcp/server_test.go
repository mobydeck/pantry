...
func (s *stubService) Store(raw models.RawItemInput, project string) (map[string]interface{}, error) {
...
func TestHandlePantryStore_TagsFromCommaString(t *testing.T) {
	...
	svc := &stubService{}
	svc.storeResult = map[string]interface{}{"id": "x", "file_path": "/f", "action": "created"}
...
func (c *capturingStub) Store(raw models.RawItemInput, project string) (map[string]interface{}, error) {
	c.lastRaw = raw
	c.lastProject = project
	return map[string]interface{}{"id": "x", "file_path": "/f", "action": "created"}, nil
}
...
func TestHandlePantrySearch_PropagatesError(t *testing.T) {
	...
	_, err := HandlePantrySearch(svc, map[string]interface{}{"query": "x"})
	if err == nil {
...
func TestHandlePantryContext_DefaultLimit(t *testing.T) {
	...
	result, err := HandlePantryContext(svc, map[string]interface{}{})
	if err != nil {
...
func TestHandlePantryContext_LimitParam(t *testing.T) {
	called := false
	capSvc := &contextCapturingStub{onContext: func(limit int) {
		called = true
		if limit != 20 {
			// Just record; will check below
		}
	}}
...
func TestHandlePantryContext_PropagatesError(t *testing.T) {
	...
	_, err := HandlePantryContext(svc, map[string]interface{}{})
	if err == nil {
...
func (c *contextCapturingStub) Store(raw models.RawItemInput, project string) (map[string]interface{}, error) {
	return map[string]interface{}{"id": "x", "file_path": "/f", "action": "created"}, nil
}
...
func TestGetStringSliceFromMap_CommaString(t *testing.T) {
	m := map[string]interface{}{"tags": "go,testing,mcp"}
...
func TestGetStringSliceFromMap_JSONArray(t *testing.T) {
	m := map[string]interface{}{"tags": `["alpha","beta","gamma"]`}
	result, ok := getStringSliceFromMap(m, "tags")
	if !ok {
		t.Fatal("getStringSliceFromMap() ok = false, want true")
	}
...
func TestGetStringSliceFromMap_NativeSlice(t *testing.T) {
	m := map[string]interface{}{"tags": []interface{}{"x", "y"}}
	result, ok := getStringSliceFromMap(m, "tags")
	if !ok {
		t.Fatal("getStringSliceFromMap() ok = false, want true")
	}
